 ...
 * on 2018-01-06 at 15:18:35 UTC 
 * Modify at your own risk.
 */

package quipsticle.bapspatil.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://bapspatil-android-nanodegree.appspot.com/_ah/api/";
  ...
  public class SayHi extends MyApiRequest<quipsticle.bapspatil.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, quipsticle.bapspatil.myApi.model.MyBean.class);
   ...
   * @return the request
   */
  public TellAJoke tellAJoke(java.util.List<java.lang.String> jokes) throws java.io.IOException {
    TellAJoke result = new TellAJoke(jokes);
    initialize(result);
    return result;
  }

  public class TellAJoke extends MyApiRequest<quipsticle.bapspatil.myApi.model.MyBean> {

    private static final String REST_PATH = "tellAJoke/{jokes}";
     ...
     * @since 1.13
     */
    protected TellAJoke(java.util.List<java.lang.String> jokes) {
      super(MyApi.this, "POST", REST_PATH, null, quipsticle.bapspatil.myApi.model.MyBean.class);
      this.jokes = com.google.api.client.util.Preconditions.checkNotNull(jokes, "Required parameter jokes must be specified.");
    }
    ...
    public TellAJoke setJokes(java.util.List<java.lang.String> jokes) {
      this.jokes = jokes;
      return this;
    }
