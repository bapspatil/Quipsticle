...
package quipsticle.bapspatil.myApi.model;
...
public final class MyBean extends com.google.api.client.json.GenericJson {
   ...
   */
  @com.google.api.client.util.Key
  private java.util.List<java.lang.String> myJokes;
   ...
   * @return value or {@code null} for none
   */
  public java.util.List<java.lang.String> getMyJokes() {
    return myJokes;
  }

  /**
   * @param myJokes myJokes or {@code null} for none
   */
  public MyBean setMyJokes(java.util.List<java.lang.String> myJokes) {
